...
// Retrieve the puntenUsed value from the session
$puntenUsed = isset($_SESSION['puntenUsed']) ? $_SESSION['puntenUsed']: false;
...
<div class="container">
    ...
    <div class="cancel-button">
        ...
        if ($puntenUsed) {
            $emailadres = isset($userData['EmailAddress']) ? $userData['EmailAddress'] : '';
            $puntenGebruik = isset($_SESSION['puntenGebruik']) ? $_SESSION['puntenGebruik'] : 0;
            deletePunten($puntenGebruik, $emailadres);
        } else {
            addPunten($puntenAantal, $connection);
            }
